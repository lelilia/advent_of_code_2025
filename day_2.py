...
if __name__ == "__main__":
    ...
    assert(res:=solve("853-1994", check_valid_1)) == (exp:=14645), f"expected {exp} got {res}"
    assert(res:=solve("853-1994", check_valid_2)) == (exp:=16532), f"expected {exp} got {res}"
    assert(res:=solve("1919078809-1919280414", check_valid_1)) == (exp:=3838338383), f"expected {exp} got {res}"
    assert(res:=solve("1919078809-1919280414", check_valid_2)) == (exp:=5757530302), f"expected {exp} got {res}"
    assert(res:=solve("1212082623-1212155811", check_valid_1)) == (exp:=1212112121), f"expected {exp} got {res}"
    assert(res:=solve("1212082623-1212155811", check_valid_2)) == (exp:=2424233333), f"expected {exp} got {res}"
    assert(res:=solve("2389-4173", check_valid_1)) == (exp:=59085), f"expected {exp} got {res}"
    assert(res:=solve("2389-4173", check_valid_2)) == (exp:=59085), f"expected {exp} got {res}"
    assert(res:=solve("7490-11616", check_valid_1)) == (exp:=219675), f"expected {exp} got {res}"
    assert(res:=solve("7490-11616", check_valid_2)) == (exp:=230786), f"expected {exp} got {res}"

    assert(res:=solve("863031-957102", check_valid_1)) == (exp:=85578493), f"expected {exp} got {res}"
    assert(res:=solve("863031-957102", check_valid_2)) == (exp:=92871415), f"expected {exp} got {res}"
    assert(res:=solve("9393261874-9393318257", check_valid_1)) == (exp:=9393293932), f"expected {exp} got {res}"
    assert(res:=solve("9393261874-9393318257", check_valid_2)) == (exp:=9393293932), f"expected {exp} got {res}"
    assert(res:=solve("541406-571080", check_valid_1)) == (exp:=16681665), f"expected {exp} got {res}"
    assert(res:=solve("541406-571080", check_valid_2)) == (exp:=17792775), f"expected {exp} got {res}"
    assert(res:=solve("1207634-1357714", check_valid_1)) == (exp:=0), f"expected {exp} got {res}"
    assert(res:=solve("1207634-1357714", check_valid_2)) == (exp:=0), f"expected {exp} got {res}"
    assert(res:=solve("36706-61095", check_valid_1)) == (exp:=0), f"expected {exp} got {res}"
    assert(res:=solve("36706-61095", check_valid_2)) == (exp:=99999), f"expected {exp} got {res}"
    assert(res:=solve("863031-957102", check_valid_1)) == (exp:=85578493), f"expected {exp} got {res}"
    assert(res:=solve("863031-957102", check_valid_2)) == (exp:=92871415), f"expected {exp} got {res}"
    assert(res:=solve("3-20", check_valid_1)) == (exp:=11), f"expected {exp} got {res}"
    assert(res:=solve("3-20", check_valid_2)) == (exp:=11), f"expected {exp} got {res}"
